<?php
	...
	session_start();
    if(!isset($_SESSION[$sessionForgotPwd]))
    {
		header("location:index.php");
    }
	$_SESSION[$sessUserEmailAtNewPassword] = $_SESSION[$sessUserEmailAtProcessForgotPwd];
	$_SESSION[$sessUserEmailAtProcessForgotPwd] = null;
	$_SESSION[$sessionForgotPwd] = null;
?>
<!DOCTYPE html>
<html lang="en">
  <head>
			...
			<div class="row text-center">
				...
				<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
					<div class="user-account">
						...
						<!-- form -->
						<form  action="process_newpassword.php" method="post">
							<div class="form-group">
								<input type="password" class="form-control" placeholder="New Password" name="newpwd" required>
							</div>
							<div class="form-group">
								<input type="password" class="form-control" placeholder="Confirm New Password" name="newpwdconf" required>
							</div>
