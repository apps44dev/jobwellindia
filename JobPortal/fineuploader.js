...
(function(global) {
    ...
    (function() {
        ...
        qq.basePrivateApi = {
            ...
            _onSubmitCallbackSuccess: function(id, name) {
                ...
                if (this._options.autoUpload) {debugger;
            ...
            _setSize: function(id, newSize) {debugger;
            ...
            _storeForLater: function(id) {debugger;
            ...
            _upload: function(id, params, endpoint) {debugger;
                var name = this.getName(id);
                if (params) {
    ...
    (function() {
        ...
        qq.uiPrivateApi = {
            ...
            _onSubmitted: function(id) {debugger;
                if (this._isEditFilenameEnabled()) {
                    this._templating.markFilenameEditable(id);
    ...
    qq.Templating = function(spec) {
        ...
        qq.extend(this, {
            ...
            updateSize: function(id, text) {debugger;
                var size = getSize(id);
                if (size) {
                    show(size);
